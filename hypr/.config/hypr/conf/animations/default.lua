...
-- Slight overshoot, so a surface lands like a drop of fluid instead of
-- easing into place. Kept mild on purpose: it must still read as fast.
hl.curve("fluidDrop", { type = "bezier", points = { {0.05, 0.9}, {0.12, 1.06} } })

--------------------------------------------------------------------------------
-- Animation Rules
--------------------------------------------------------------------------------
hl.animation({ leaf = "windows", enabled = true, speed = 3, bezier = "md3_decel", style = "popin 60%" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 3.4, bezier = "fluidDrop", style = "popin 55%" })
...
hl.animation({ leaf = "layersIn", enabled = true, speed = 3.4, bezier = "fluidDrop", style = "slide" })
